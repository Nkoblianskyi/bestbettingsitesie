...
export default function AboutPage() {
  return (
    <PolicyLayout title="About bestukbettingsiteslist.com">
      <PolicySection title="Impressum — Publisher">
        ...
        <p className="mt-2">
          ...
          UK bookmakers licensed by the UK Gambling Commission. We do not accept bets, hold player funds, or act as a
          gambling operator in any capacity.
        </p>
      </PolicySection>
