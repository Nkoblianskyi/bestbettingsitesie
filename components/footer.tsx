      ...
      <div className="container mx-auto max-w-5xl px-4 py-8 xl:max-w-6xl">
        ...
        <div className="mb-8 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6">
            ...
            <Link href="https://gamblingcare.ie/" target="_blank" rel="noopener noreferrer" className="inline-block rounded bg-black px-2 py-1.5 text-xs font-semibold text-slate-800 hover:bg-slate-100">
