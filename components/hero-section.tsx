    ...
    <div className="relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto max-w-5xl px-4 xl:max-w-6xl py-10 md:py-14">
        ...
        <div className="flex flex-wrap items-center gap-2 mb-4">
          <span className="inline-flex items-center gap-1.5 rounded-full bg-[hsl(var(--gold))]/20 border border-[hsl(var(--gold))]/40 px-3 py-1 text-[11px] font-bold uppercase tracking-widest text-[hsl(var(--gold))]">
