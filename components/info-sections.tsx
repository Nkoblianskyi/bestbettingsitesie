...
import { BookOpen, BarChart2, User, Gift, ShieldCheck, Heart } from "lucide-react"
          ...
          return (
            ...
            >
              <div className="flex items-start gap-3">
                <div className="shrink-0 mt-0.5 flex items-center justify-center w-8 h-8 rounded-lg bg-[hsl(var(--navy))]/8">
                  <Icon className="w-4 h-4 text-[hsl(var(--navy))]" strokeWidth={2} />
                </div>
                <div>
